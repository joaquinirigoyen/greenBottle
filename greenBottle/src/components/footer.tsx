...
const Footer = () => {
  return (
    <div className="flex flex-col bg-gradient-to-r from-lime-700 to-yellow-950 h-36 pt-10 justify-between w-full">
    <span className='flex text-white text-5xl justify-center gap-6'>
      ...
      <span className="font-sans text-center text-white">Joaquin Irigoyen 2024</span>
    </div>
  );
};
